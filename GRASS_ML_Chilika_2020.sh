...
r.import input=/Users/polinalemenkova/grassdata/Chilika/LC08_L2SP_140046_20200303_20200822_02_T1_SR_B1.TIF output=L_2020_01 extent=region resolution=region
r.import input=/Users/polinalemenkova/grassdata/Chilika/LC08_L2SP_140046_20200303_20200822_02_T1_SR_B2.TIF output=L_2020_02 extent=region resolution=region
r.import input=/Users/polinalemenkova/grassdata/Chilika/LC08_L2SP_140046_20200303_20200822_02_T1_SR_B3.TIF output=L_2020_03 extent=region resolution=region
r.import input=/Users/polinalemenkova/grassdata/Chilika/LC08_L2SP_140046_20200303_20200822_02_T1_SR_B4.TIF output=L_2020_04 extent=region resolution=region
r.import input=/Users/polinalemenkova/grassdata/Chilika/LC08_L2SP_140046_20200303_20200822_02_T1_SR_B5.TIF output=L_2020_05 extent=region resolution=region
r.import input=/Users/polinalemenkova/grassdata/Chilika/LC08_L2SP_140046_20200303_20200822_02_T1_SR_B6.TIF output=L_2020_06 extent=region resolution=region
r.import input=/Users/polinalemenkova/grassdata/Chilika/LC08_L2SP_140046_20200303_20200822_02_T1_SR_B7.TIF output=L_2020_07 extent=region resolution=region
# shaded relief
...
r.colors L_2020_clusters color=roygbiv
...
d.out.file output=Chilika_2020 format=jpg --overwrite
# Mapping rejection probability
d.mon wx1
g.region raster=L_2020_clusters -p
r.colors L_2020_cluster_reject color=soilmoisture -e
d.rast shaded_relief1
d.vect isolines color='100:93:134' width=0
...
d.legend raster=shaded_relief1 title="Relief, m" title_fontsize=19 font="Helvetica" fontsize=17 bgcolor=white border_color=white -f
d.out.file output=Chilika_2020_reject format=jpg --overwrite
#
# --------------------- MACHINE LEARNING ------------------------>
...
r.learn.predict group=L_2020 load_model=rf_model.gz output=rf_classification --overwrite
...
d.grid -g size=00:30:00 color=white width=0.1 fontsize=16 text_color=white
d.legend raster=rf_classification title="RF 2020" title_fontsize=19 font="Helvetica" fontsize=17 bgcolor=white border_color=white
d.legend raster=shaded_relief1 title="Relief, m" title_fontsize=19 font="Helvetica" fontsize=17 bgcolor=white border_color=white -f
d.out.file output=RF_2020 format=jpg --overwrite
# 2. SVM ------------------------>
...
# perform prediction using r.learn.predict
r.learn.predict group=L_2020 load_model=mlpc_model.gz output=mlpc_classification --overwrite
# check raster categories automatically applied to the classification output
...
d.grid -g size=00:30:00 color=white width=0.1 fontsize=16 text_color=white
d.legend raster=mlpc_classification title="MLPC 2020" title_fontsize=19 font="Helvetica" fontsize=17 bgcolor=white border_color=white
d.legend raster=shaded_relief1 title="Relief, m" title_fontsize=19 font="Helvetica" fontsize=17 bgcolor=white border_color=white -f
d.out.file output=MLPC_2020 format=jpg --overwrite
